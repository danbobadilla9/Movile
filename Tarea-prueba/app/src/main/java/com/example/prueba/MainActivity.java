    ...
    public void onCreate(Bundle b) {
        ...
        btnWrite.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    if(myTag ==null) {
                        Toast.makeText(context, ERROR_DETECTED,
                                Toast.LENGTH_LONG).show();
                    } else {
                        write(message.getText().toString(), myTag);
                        Toast.makeText(context, WRITE_SUCCESS, Toast.LENGTH_LONG
                        ).show();
                    }
                } catch (IOException e) {
        ...
        if (nfcAdapter == null) {
            ...
            Toast.makeText(this, "Este dispositivo no posee NFC.",
                    Toast.LENGTH_LONG).show();
            finish();
        }
...
// String tagId = new String(msgs[0].getRecords()[0].getType());
        ...
        String textEncoding = ((payload[0] & 128) == 0) ? "UTF-8" : "UTF-16"; // Leetexto codificado
        int languageCodeLength = payload[0] & 0063; // Lee el código del idioma, porejemplo "en"
