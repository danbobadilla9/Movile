package com.example.medir_capacitor;
            ...
            try{
                while(true){
                    ...
                    if(inputStream.available() > 0){
                        ...
                        String string2 = String.valueOf(string.charAt(0)) +String.valueOf(string.charAt(1));
                        Log.d("PRUEBA", string2);
                            datos.post(new Runnable() {
                                @Override
                                public void run() {
                                    datos.append(string2+" microFaradios\n");
